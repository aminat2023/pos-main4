...
<div class="container mt-4" style="background-color: aliceblue">
    ...
    <!-- Filter Form -->
    <form method="GET" action="{{ route('profit_loss.index') }}" class="row mb-4" onsubmit="showAndPrintReport(event)">
        <div class="col-md-3">
            <label>From</label>
    ...
    <!-- Report Table (Initially nHidden) -->
...
<script>
    function showAndPrintReport(event) {
