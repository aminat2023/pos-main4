        ...
        <form action="{{ route('preferences.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @if (!empty($preferences['business_logo']))
                    <img src="{{ asset('storage/' . $preferences['business_logo']) }}" alt="Logo"
            ...
            <div class="form-group">
                ...
                <input type="text" name="office_address" class="form-control"
                    value="{{ $preferences['office_address'] ?? '' }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="receipt_header" class="form-control"
                    value="{{ $preferences['receipt_header'] ?? '' }}">
            </div>

            <div class="form-group">
                <label>Receipt Footer</label>
                <input type="text" name="receipt_footer" class="form-control"
                    value="{{ $preferences['receipt_footer'] ?? '' }}">
            </div>

            <div class="form-group">
                <label>Default Language</label>
                <select name="default_language" class="form-control form-control-sm" onchange="this.form.submit()">
            ...
            <div class="form-group">
                ...
                <button type="button" class="btn btn-sm btn-secondary mt-2" onclick="addBankInput()">Add Another
                    Bank</button>
            </div>
